<template>
  <div class="h-screen relative isolate overflow-hidden bg-gradient-to-b from-gray pt-14">
    <div class="absolute top-0 w-full mx-auto p-4">
      <ThemeToggle />
    </div>
    <div class="absolute inset-y-0 right-1/2 -z-10 -mr-96 w-[200%] origin-top-right skew-x-[-30deg] bg-primary sm:-mr-80 lg:-mr-96" aria-hidden="true" />
    <div class="mx-auto max-w-7xl px-6 py-28 lg:px-8">
      <div class="mx-auto max-w-2xl ">
        <svg class="fill-accent h-28 w-28" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 319.69 183.17">
          <g id="icon-dark">
            <g>
        ...
        <h1
          class="bg-gradient-to-t from-primary to-accent bg-clip-text text-transparent
        font-main max-w-2xl text-4xl font-bold tracking-tight sm:text-6xl lg:col-span-2 xl:col-auto"
        >
          Give your app the look it deserves<span class="bg-gradient-to-t from-primary to-accent bg-clip-text text-transparent">.</span>
        </h1>
        <div class="mt-6 max-w-xl lg:mt-0 xl:col-end-1 xl:row-start-1">
          <p class="text-lg leading-6 text-muted">
    ...
    <div class="absolute inset-x-0 bottom-0 -z-10 h-24 bg-gradient-to-t from-primary sm:h-32" />
  </div>
</template>
