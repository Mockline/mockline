...
const theme = tv({
  slots: {
    ...
    indicator: 'absolute left-0 inset-y-2 w-[var(--radix-tabs-indicator-size)] translate-x-[var(--radix-tabs-indicator-position)] transition-[translate,width] duration-200 bg-[var(--ui-bg-elevated)] rounded-[calc(var(--ui-radius)*1.5)] shadow-xs',
