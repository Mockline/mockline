...
export const pageMarqueeTv = tv({
  ...
  variants: {
    ...
    overlay: {
      true: {
        root: 'before:absolute before:pointer-events-none before:content-[""] before:z-2 before:from-(--content-area-bg) before:to-transparent after:absolute after:pointer-events-none after:content-[""] after:z-2 after:from-(--content-area-bg) after:to-transparent'
      }
    }
  },
  compoundVariants: [
...
type PageMarqueeVariants = VariantProps<typeof pageMarqueeTv>

export type PageMarqueeProps = {
  as?: any
