  ...
  return {
    ...
    compoundVariants: [
      ...
      })),
      {
        ...
        variant: 'solid',
        class:
          'text-text-white bg-bg-surface hover:bg-surface/80 disabled:bg-weak aria-disabled:bg-[var(--ui-bg-inverted)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--ui-border-inverted)]',
      },
      {
        color: 'neutral',
        variant: 'outline',
      ...
      },
      {
        ...
        variant: 'soft',
        class:
          'text-text-white bg-bg-sub hover:bg-[var(--ui-bg-accented)]/75 focus-visible:bg-[var(--ui-bg-accented)]/75 disabled:bg-[var(--ui-bg-elevated)] aria-disabled:bg-[var(--ui-bg-elevated)]',
      },
      {
        color: 'neutral',
        variant: 'subtle',
        class:
          'ring ring-inset ring-bg-surface text-text-white bg-bg-surface/70 hover:bg-[var(--ui-bg-accented)]/75 disabled:bg-[var(--ui-bg-elevated)] aria-disabled:bg-[var(--ui-bg-elevated)] focus-visible:ring-2 focus-visible:ring-[var(--ui-border-inverted)]',
      },
      {
        color: 'neutral',
        variant: 'ghost',
