...
const headerClasses = computed(() => twMerge(
  'flex items-center justify-between w-full h-[var(--header-height)] p-4 bg-neutral-100 dark:bg-neutral-900',
  props.sticky && 'sticky top-0 z-10',
  props.glass && 'backdrop-blur bg-neutral-100/50 dark:bg-neutral-900/50',
  props.class,
))
